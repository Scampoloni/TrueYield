...
**Zahlungsbereitschaft (aus Marktdaten & Analogie zu Compliance-Tools):**
- **Small Asset Manager:** CHF 2.000–3.000/Monat — vergleichbar mit Bloomberg Terminal-Zusatzmodulen
- **Mid-Size Bank:** CHF 8.000–12.000/Monat — deutlich günstiger als eine zusätzliche FTE-Stelle im Compliance-Team (~CHF 120.000/Jahr)
- **Enterprise / Tier-1-Bank:** CHF 25.000–50.000/Monat — ROI klar: 1 vermiedene Greenwashing-Busse deckt mehrere Jahre Lizenzkosten

**Kaufbereitschaft: hoch**
- 78% der institutionellen Anleger bereit, für nachweislich echte ESG-Verifikation Premium zu zahlen
- Greenwashing-Bussen (DWS: $46M) machen den ROI unmittelbar messbar
- Compliance-Budgets sind vorgebunden und wachsen jährlich (99% der Institute berichten steigende Ausgaben)

**Preismodell:** Jahresabonnement mit optionalem Pay-per-Audit für kleinere Institute

---

### USER EXPERIENCE

**Nutzererlebnis auf einer Skala von Frustriert bis Zufrieden:**

**Fund Manager:**
- Vorher (ohne TrueYield): Frustriert — stundenlange Google-Recherche, kein Überblick, Angst etwas zu übersehen
- Mit TrueYield: Zufrieden — Portfolio einreichen, Status verfolgen, Ergebnis mit Dokumentation erhalten
- Kern-Emotion: **Erleichterung** ("Ich muss das nicht mehr manuell machen")

**Auditor / Compliance Officer:**
- Vorher: Frustriert — überflutet mit Requests, keine Zeit für Tiefenprüfung, persönliches Haftungsrisiko
- Mit TrueYield: Zufrieden — strukturierte Queue, KI-Evidenz als Entscheidungsgrundlage, Audit Trail automatisch generiert
- Kern-Emotion: **Sicherheit** ("Ich kann meine Entscheidung belegen")

**Kritische UX-Anforderungen:**
- Finale Entscheidung liegt immer beim Menschen (Compliance-Teams akzeptieren keine Blackbox)
- Evidence muss auf Artikel-Ebene nachvollziehbar sein (nicht nur Score, sondern Quelle)
- PDF-Export muss ohne Extra-Aufwand richtig formatiert sein (direkt für Regulatoren verwendbar)
